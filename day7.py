...
class EmployeeReport:
    def generate_report(self, employee):
        return f"Employee: {employee.name}, Position: {employee.ption}, Salary: {employee.salary}"
...
print(generator.generate_report("John Doe")) # Output: Salary Ret: John Doe earns 5000
print(generator.generate_report("Jane Smith")) # Output: Salaryort: Jane Smith earns 6000